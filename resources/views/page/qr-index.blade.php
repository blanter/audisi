        ...
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white p-6">
                <div class="custom-box-qr">
                    ...
                    <div class="box-qr">
                        <a href="{{route('datatamu')}}" title="Data Tamu">
